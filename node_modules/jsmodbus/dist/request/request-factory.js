...
const read_device_identification_js_1 = __importDefault(require("./read-device-identification.js"));
...
const debug = (0, debug_1.default)('request-factory');
            ...
            if ((0, codes_1.isFunctionCode)(fc)) {
                switch (fc) {
                    ...
                    case codes_1.FC.READ_DEVICE_IDENTIFICATION:
                        return read_device_identification_js_1.default.fromBuffer(buffer);
