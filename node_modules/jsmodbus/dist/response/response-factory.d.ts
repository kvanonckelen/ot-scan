...
export default class ResponseFactory {
    static fromBuffer(buffer: Buffer): ExceptionResponseBody | ReadCoilsResponseBody | ReadDeviceIdentificationBody | ReadHoldingRegistersBody | ReadInputRegistersBody | WriteMultipleCoilsBody | WriteMultipleRegistersBody | WriteSingleCoilBody | WriteSingleRegisterBody | ReadDiscreteInputsBody | null;
}
