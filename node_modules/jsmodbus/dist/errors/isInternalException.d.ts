export type InternalErrorMessages = 'InvalidStartAddress' | 'InvalidQuantity' | 'InvalidArraySize' | 'InvalidBufferSize' | 'InvalidCoilsInput' | 'InvalidType_MustBeBufferOrArray' | 'InvalidValue';
