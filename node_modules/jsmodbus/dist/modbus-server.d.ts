...
export default class ModbusServer extends EventEmitter {
    ...
    get coils(): Buffer<ArrayBufferLike>;
    get discrete(): Buffer<ArrayBufferLike>;
    get holding(): Buffer<ArrayBufferLike>;
    get input(): Buffer<ArrayBufferLike>;
    ...
    on(event: 'readDeviceIdentification', listener: (request: AbstractRequest, cb: BufferCB) => void): this;
    on(event: 'preReadDeviceIdentification', listener: (request: AbstractRequest, cb: BufferCB) => void): this;
    on(event: 'postReadDeviceIdentification', listener: (request: AbstractRequest, cb: BufferCB) => void): this;
    ...
    emit(event: 'readDeviceIdentification', request: AbstractRequest, cb: BufferCB): boolean;
    emit(event: 'preReadDeviceIdentification', request: AbstractRequest, cb: BufferCB): boolean;
    emit(event: 'postReadDeviceIdentification', request: AbstractRequest, cb: BufferCB): boolean;
